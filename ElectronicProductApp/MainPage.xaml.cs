...
namespace ElectronicProductApp
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public MainPage()
        {
            ...
            this.listProduct.ItemsSource = this.info.Get();
        }

        private void listProduct_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            var selected = this.listProduct.SelectedItem as Product;
            this.Frame.Navigate(typeof(ProductDetails), new NavParam { Id = selected.Id });
        }
    }
}
